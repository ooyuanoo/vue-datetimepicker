<template>
    <div>
        ...
        <transition name="slide">
            <div class="date-time-picker" ref="timepicker" v-if="show && isShow">
                ...
                <div class="section-part footer clearfix">
                    <button type="button" class="btn btn-clear" v-text="pageText.btn[0]"
                            @click="selectTimeClick($event, true)"></button>
